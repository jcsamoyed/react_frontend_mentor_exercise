...
export default function BlogPreviewCard() {
  return (
    ...
    >
      <div className='flex flex-col gap-6 p-6 bg-white rounded-[20px] border border-gray-950 max-w-81.75 shadow-[8px_8px_black]'>
        ...
        <div className='flex flex-col items-start gap-3'>
          <span className='text-gray-950 text-xs font-extrabold bg-yellow-300 py-1 px-3 rounded-sm'>
            Learning
          </span>
          <span className='text-xs text-gray-950 font-medium'>
            Published 30 Dec 2025
          </span>
          <h1 className='text-xl text-gray-950 font-extrabold'>
